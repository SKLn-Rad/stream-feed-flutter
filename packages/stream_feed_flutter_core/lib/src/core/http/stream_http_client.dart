...
import 'package:stream_feed_flutter_core/src/core/error/stream_feeds_dio_error.dart';
import 'package:stream_feed_flutter_core/src/core/error/stream_feeds_error.dart';
import 'package:stream_feed_flutter_core/src/core/http/interceptor/logging_interceptor.dart';
import 'package:stream_feed_flutter_core/src/core/http/location.dart';
import 'package:stream_feed_flutter_core/src/core/http/typedefs.dart';
import 'package:stream_feed_flutter_core/src/core/platform_detector/platform_detector.dart';
import 'package:stream_feed_flutter_core/src/core/util/extension.dart';
import 'package:stream_feed_flutter_core/version.dart';
...
class StreamHttpClient {
  ...
  StreamHttpClient(
    ...
    Logger? logger,
        ...
        httpClient = dio ?? Dio() {
    httpClient
      ..options.receiveTimeout = Duration(milliseconds: this.options.receiveTimeout.inMilliseconds)
      ..options.connectTimeout = Duration(milliseconds: this.options.connectTimeout.inMilliseconds)
